                ...
                {{-- <div class="max-w-xl"> --}}
                    ...
                    <form action="{{route('course.update', $course->id)}}" method="POST" class="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" value="{{$course->name}}" disabled autocomplete="name" />
                        ...
                        <div>
                            ...
                            value="{{$course->description}}" disabled autocomplete="description" />
